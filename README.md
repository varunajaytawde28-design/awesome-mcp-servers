...
- [Axiom Hub](https://github.com/varunajaytawde28-design/smm-sync) - Persistent decision memory and contradiction detection for AI coding agents. Enforces architectural consistency across sessions via graph-based memory, PreToolUse session blocking, and a FastAPI dashboard for human resolution.
